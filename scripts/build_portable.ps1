...
$ImportCheck = "import streamlit, pandas, duckdb, plotly, pyarrow, openpyxl, numpy; print('OK')"
...
Write-Host ""
Write-Host "Hotovo. Spustte run_dashboard.bat nebo run_etl.bat (pouzije runtime\python)." -ForegroundColor Green
exit 0
